  ...
  return (
    <div className={darkmode ? 'dark' : ''}>
      <div className='dark:bg-gray-900'>
            ...
            <div className="container flex flex-wrap items-center justify-between mx-auto">
              ...
              <div className="flex md:order-2">
                ...
                <Link className='text-white' to={'/register'}>
                  <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ml-2">
                    Registration
                  </button>
                </Link>
          ...
          <div className=''>
            <div className="flex gap-16">
              <div className="w-1/2 p-4 text-left pt-8 ml-12">
                ...
                <p className='mt-4 dark:text-slate-50'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Provident rerum nisi obcaecati. Nostrum voluptas recusandae, modi culpa neque laudantium sunt qui fugit facilis mollitia maiores facere iure. Natus, assumenda rem!</p>
                <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-4">Explore More</button>
              </div>
              <div className="w-1/2">
        ...
        {/* Carousel */}
        <div className='mt-16'>
          <p className='text-2xl text-blue-600 font-bold dark:text-red-50 mb-4'>Our Services</p>
          <div className="slider">
            <div className="slide-track">
              ...
              <div className="slide">
                <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 ml-4">
                  <a href="#">
                    <img className="rounded-t-lg" src="/docs/images/blog/image-1.jpg" alt="" />
                  </a>
                  <div className="p-5">
        ...
        {/* Contact */}
        <div className='w-3/4 grid justify-self-center ml-32'>
          <p className='text-2xl text-blue-600 font-bold dark:text-red-50 mb-8'>Contact Us</p>
        ...
        <div className='mt-16'>
          ...
          <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
            ...
            <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                <a href="https://flowbite.com/" className="flex items-center">
                  ...
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">EduWeb</span>
                </a>
              </div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#" className="hover:underline">EduWeb</a>. All Rights Reserved.
              </span>
